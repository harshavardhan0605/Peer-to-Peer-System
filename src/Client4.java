...
public class Client4 {
    ...
    public Client4(String address, int port)
    {
        ...
        try
        {
            ...
            System.out.println("Peer4 Connected");
            ...
            System.out.println("Registering on Server");
	            FileReader fileReader = new FileReader(Index+"peer4");
            				...
            				int filesize = 2022386, bytesRead, currentTot = 0;
            				 byte [] bytearray  = new byte [filesize];
            			        ...
            			        bos.close();
            			         String store = "\n"+ num + "\n" + title ; 
            				socket1.close();
            				fw = new FileWriter(Index+"peer4",true);
    ...
    {
        Client4 client = new Client4("127.0.0.1", 7734);
    }
