...
public class Client1 {
    ...
    public Client1(String address, int port)
    {
        ...
        try
        {
            ...
            System.out.println("Peer1 Connected");
            ...
            System.out.println("Registering on Server");
	            FileReader fileReader = new FileReader(Index+"peer1");
            	...
            	case 1: 		System.out.println("Enter RFC Number");
            				...
            				int filesize = 2022386, bytesRead, currentTot = 0;
            				 byte [] bytearray  = new byte [filesize];
            			        ...
            			        FileOutputStream fos = new FileOutputStream("/Users/appleapple/Desktop/harsha2/"+num+".pdf");
            			        ...
            			        bos.close();
            			         String store = "\n"+ num + "\n" + title ; 
            				socket1.close();
            				fw = new FileWriter(Index+"peer1",true);
    ...
    {
        Client1 client = new Client1("127.0.0.1", 7734);
    }
