...
public class Client3 {
    ...
    public Client3(String address, int port)
    {
        ...
        try
        {
            ...
            System.out.println("Peer3 Connected");
            //System.out.println(socket.getLocalSocketAddress());
            String Index = "/Users/appleapple/Desktop/harsha1/";
            ...
            System.out.println("Registering on Server");
	            FileReader fileReader = new FileReader(Index+"peer3");
            ...
            switch(i)
            {
            	...
            	case 1: 		System.out.println("Enter RFC Number");
            	         ...
            	         if(q>0) break;
            				...
            				DataInputStream reply =new DataInputStream(socket1.getInputStream());
            				...
            				int filesize = 2022386, bytesRead, currentTot = 0;
            				 byte [] bytearray  = new byte [filesize];
            			        ...
            			        bos.close();
            			         String store = "\n" + num + "\n" + title ; 
            				socket1.close();
            				fw = new FileWriter(Index+"peer3",true);
    ...
    {
        Client3 client = new Client3("127.0.0.1", 7734);
    }
